import { DocumentScannerTwoTone, KeyboardArrowDownTwoTone, SettingsTwoTone } from '@mui/icons-material';
    ...
    >
      <Box alignItems="center" display="flex">
        ...
        <Box>
          ...
          <Typography variant="subtitle2">{t('Manage Settings')}</Typography>
        </Box>
      </Box>
      <Box mt={{ md: 0, xs: 3 }}>
        <Button
