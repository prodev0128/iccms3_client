import { DesignServicesTwoTone, DocumentScannerTwoTone, KeyboardArrowDownTwoTone } from '@mui/icons-material';
    ...
    >
      <Box alignItems="center" display="flex">
        <AvatarPageTitle variant="rounded">
          <DesignServicesTwoTone fontSize="large" />
        </AvatarPageTitle>
        <Box>
          <Typography gutterBottom component="h3" variant="h3">
            {t('Codes')}
          </Typography>
          <Typography variant="subtitle2">{t('Manage Codes')}</Typography>
        </Box>
      </Box>
      <Box mt={{ md: 0, xs: 3 }}>
        <Button
