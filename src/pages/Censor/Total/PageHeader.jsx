import { DocumentScannerTwoTone, FindInPageTwoTone, KeyboardArrowDownTwoTone } from '@mui/icons-material';
    ...
    >
      <Box alignItems="center" display="flex">
        <AvatarPageTitle variant="rounded">
          <FindInPageTwoTone fontSize="large" />
        </AvatarPageTitle>
        <Box>
          <Typography gutterBottom component="h3" variant="h3">
            {t('Total')}
          </Typography>
          <Typography variant="subtitle2">{t('All data in this page')}</Typography>
        </Box>
      </Box>
      <Box mt={{ md: 0, xs: 3 }}>
        <Button
